 ...
 *
 */
class RulesEngineTests extends GroovyTestCase {
    @Override
...
ruleset("milkshake") {
    ...
    void testTestRulesDsl() {
        ...
        assert fails == ['\n-----\nTest 1 failed', 'Values are not equal:', '(class java.lang.String) failed != (class java.lang.String) passed', 'Facts: [nett_income:400, incomeTest:failed, income:900, expenses:500]']
